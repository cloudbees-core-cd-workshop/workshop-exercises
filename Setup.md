...
6. **Select team master creation recipe** - click on the drop-down and select the **Java & Web Development** recipe;<p><img src="img/setup-create-team-recipe-2.png" width=450/>
